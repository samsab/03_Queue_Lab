...
//Check to make sure that numItems returns correct result on a fresh instance of the ArrayQueue class
...
//Test to make sure you are throwing an exception if remove is called improperly
